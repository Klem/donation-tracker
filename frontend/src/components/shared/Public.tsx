...
import { useRecentDonations } from "@/hooks/usePonder";

const Public = () => {

    // Fetch recent donations from Ponder (instead of getLogs)
    const { data: latestDonations = [], isLoading } = useRecentDonations(10);

    // Keep contract reads for real-time aggregated stats
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            {/* Latest Donations - Now powered by Ponder! */}
